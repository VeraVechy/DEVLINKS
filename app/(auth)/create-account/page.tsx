      ...
      <div className="w-full max-w-[476px]">
        ...
        <div className="bg-white rounded-[12px] p-[32px] md:p-[40px]">
          <div className="mb-[40px]">
            <h1 className="font-bold text-[24px] md:text-[32px] mb-[8px]">
              Create account
            </h1>
          ...
          <form className="flex flex-col gap-[24px]">
            <fieldset>
              <label
                htmlFor="email"
                className="text-[12px] text-gray mb-[4px] inline-block leading-[18px]"
              >
                Email Address
              </label>
              <Input
            ...
            <p className="text-[12px] text-gray-alt">
              Password must contain at least 8 characters
            </p>
            <Button formAction={signup} isLoading={isPending}>
              Create new account
            </Button>
            <div className="text-center">
              Already an account? <br className="md:hidden" />{" "}
